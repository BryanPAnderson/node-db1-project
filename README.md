...
Visit [SQL Try Editor at W3Schools.com](https://www.w3schools.com/Sql/trysql.avmwasp?filename=trysql_select_all) using Chrome and build the queries below. Once they work copy them to the `queries.sql` file at the root of the project.
